...
> Proyecto ELEMENT Cotizador: para animaciones alineadas al producto, usar primero
> [element-motion-system.md](element-motion-system.md). Este archivo queda como
> referencia general de Tailwind.
