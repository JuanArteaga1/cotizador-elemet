...
**Contexto actual:** Aplicada a **ELEMENT Cotizador** con React+TS+Vite+Tailwind. Mobile-first (max 430px), tema oscuro, acento dorado #b69462. Usar Tailwind v4 con CSS-first configuration.
...
- **[references/element-motion-system.md](references/element-motion-system.md)** — Animaciones especificas para ELEMENT Cotizador con Tailwind v4 CSS-first
